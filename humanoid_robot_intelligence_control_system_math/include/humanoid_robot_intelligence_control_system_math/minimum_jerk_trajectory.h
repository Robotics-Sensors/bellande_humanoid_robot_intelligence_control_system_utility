...
class MinimumJerk {
public:
  MinimumJerk(double ini_time, double fin_time, std::vector<double_t> ini_pos,
              std::vector<double_t> ini_vel, std::vector<double_t> ini_acc,
              std::vector<double_t> fin_pos, std::vector<double_t> fin_vel,
