...
typedef struct {
  ...
  double start_time_delay_ratio_x, start_time_delay_ratio_y,
      start_time_delay_ratio_z;
  double start_time_delay_ratio_roll, start_time_delay_ratio_pitch,
      start_time_delay_ratio_yaw;
  double finish_time_advance_ratio_x, finish_time_advance_ratio_y,
      finish_time_advance_ratio_z;
  double finish_time_advance_ratio_roll, finish_time_advance_ratio_pitch,
